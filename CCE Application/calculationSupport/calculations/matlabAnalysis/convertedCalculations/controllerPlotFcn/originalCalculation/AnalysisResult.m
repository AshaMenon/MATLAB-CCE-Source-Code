classdef AnalysisResult < matlab.mixin.Copyable
    %AnalysisResult Define result of an OPMAnalysis run
    % This class defines the result object, returned by OPMAnalysis.run.
    ...
    %     TimeSpan            - AnalysisTSpanResult vector
    ...
    %     (Static)
    %     addTimeSpanResult   - add AnalysisTSpanResult object
    %     newResultTable      - create AnalysisResultTable object
    %     newTimeSpanResult   - create TimeSpanResult object
    %
    %     (Non-static)
