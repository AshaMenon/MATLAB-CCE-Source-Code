function [dVal, dQual, dTime] = derivedSubtract(V1, Q1, T1, V2, Q2, T2, V3, Q3, T3, V4, Q4, T4, V5, Q5, T5, V6, Q6, T6, V7, Q7, T7, V8, Q8, T8, V9, Q9, T9, V10, Q10, T10, V11, Q11, T11, V12, Q12, T12, V13, Q13, T13, V14, Q14, T14, V15, Q15, T15, V16, Q16, T16, V17, Q17, T17, V18, Q18, T18, V19, Q19, T19, V20, Q20, T20)
%DERIVEDSUBTRACT Compute derived subtraction with quality
%   [dVal, dQual] = DERIVEDSUBTRACT(V1, Q1, T1, V2, Q2, T2, ...) computes V1 - V2, taking
...
%   2. If (Quality1=NotRunning) And (Quality2=Running) -> Use -Value2; Result Quality2
