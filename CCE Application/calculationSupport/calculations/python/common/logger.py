...
class Logger:
    ...
    def __init__(self, log_file_name = 'STDOUT',  category = '', unique_id = 'None', log_level = 255, logger_path_env = 'LoggerPath'):
        ...
        if isinstance(log_level, str):
            self.__log_level = lg.LogMessageLevel[log_level]
        else:
            self.__log_level = lg.LogMessageLevel(log_level)  
