function [outputs, errorCode] = bpf_stats(parameters,inputs)
    %BPF_STATS Function to call the Python bpf_statsfunction
    ...
    outputPy = eval('py.BPFstatsFcnCCE.bpf_stats(parameters, inputs)');
