function [outputs, errorCode] = LinearBasicityModel(parameters,inputs)
...
%         end
        ...
        filePath = which('TrainLinearBasicity.py');
        filePath = erase(filePath,'\TrainLinearBasicity.py');
        ...
        outputPy = py.CCEScripts.TrainLinearBasicity.TrainLinearBasicity(parameters, inputs);
