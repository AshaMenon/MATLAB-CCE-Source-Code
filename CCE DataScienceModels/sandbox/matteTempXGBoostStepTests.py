...
from sandbox import matteTempXGBoost as xg

predictedMatteTemp = xg.mdl.predict(predictors)
...
axs[0].title.set_text('Step Tests (Actual Data) - XGBoost Model')
...
predictedMatteTemp2 = xg.mdl.predict(predictors)
...
predictedMatteTemp3 = xg.mdl.predict(predictors)
...
predictedMatteTempBaseline = xg.mdl.predict(predictors)

predictors = stepChange1[predictorTags]
predictedMatteTemp1 = xg.mdl.predict(predictors)
