function [outputs, errorCode] = ExecuteCalculate(parameters,inputs)
    ...
    try
        ...
        filePath = which('Calculate.py');
        filePath = erase(filePath,'\Calculate.py');
        ...
        outputPy = eval('py.Calculate(parameters, inputs)');
