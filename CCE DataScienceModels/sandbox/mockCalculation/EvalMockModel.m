function [outputs, errorCode] = EvalMockModel(parameters,inputs)
    %CALCULATE Function to call the Python EvalMockModel
    try
        ...
        filePath = which('EvalMockModel.py');
        filePath = erase(filePath,'\EvalMockModel.py');
        ...
        outputPy = eval('py.EvalMockModel.EvalMockModel(parameters, inputs)');
