function [outputs, errorCode] = EvalXGEBoostBasicityModel(parameters,inputs)
    %EvalXGEBoostBasicityModel Function to call the Python XGEBoostBasicityModel
    try
        ...
        filePath = which('EvaluateXGEBoostBasicity.py');
        filePath = erase(filePath,'\EvaluateXGEBoostBasicity.py');
        ...
        outputPy = eval('py.EvaluateXGEBoostBasicity.EvaluateXGEBoostBasicity(parameters, inputs)');
