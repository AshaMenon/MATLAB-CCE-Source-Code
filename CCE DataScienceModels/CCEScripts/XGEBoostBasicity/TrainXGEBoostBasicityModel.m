function [outputs, errorCode] = TrainXGEBoostBasicityModel(parameters,inputs)
...
%         end
        ...
        filePath = which('TrainXGEBoostBasicity.py');
        filePath = erase(filePath,'\TrainXGEBoostBasicity.py');
        ...
        outputPy = py.CCEScripts.TrainXGEBoostBasicity.TrainXGEBoostBasicity(parameters, inputs);
