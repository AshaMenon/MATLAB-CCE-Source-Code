...
def TrainLinearBasicity(parameters, inputs):
    ...
    log.log_info('--------------------------------------------------------------')
    log.log_info('Beginning Training Linear Basicity Model')
    ...
    try:
        ...
        if num_ts == 0:
            ...
            raise Exception('Not enough data to perform TrainLinearBasicity')
        ...
        parameters['addShiftsToPredictors'] = {'add': True, 'nLags': 5, 'on': ["Specific Oxygen Actual PV", 
                                                                               "Specific Silica Actual PV", 
                                                                               "Matte feed PV filtered", 
                                                                               "Lance oxygen flow rate PV", 
                                                                               "Lance air flow rate PV", 
                                                                               "Lance feed PV", "Silica PV", 
                                                                               "Lump Coal PV", 
        ...
        explained_variance, mean_absolute_error, mse, r2, fullpath = LBModel.train(trainFrac, maxTrainSize, testSize, numIters, path, modelName)
