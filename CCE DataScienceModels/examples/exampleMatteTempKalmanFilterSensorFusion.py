...
plt.title('Matte Temperature modelling')
plt.legend()

visualise.plotTimeSeriesResults(testResultsLinear, origSmoothedResponsesTest, "Linear Model - Matte Temperature (Test Results)")
visualise.plotTimeSeriesResults(testResultsForest, origSmoothedResponsesTest, "Forest Model - Matte Temperature (Test Results)")
...
plt.title("Kalman - Matte Temperature (Test Results)", fontsize=15)
