...
# Hardcoded values
# kf.R[0, 0] = 3.468709931767025
# kf.R[1, 1] = 0.07868815228133651+3
...
plt.title('Basicity modelling')
plt.legend()

#%%
visualise.plotTimeSeriesResults(testResultsLinear, origSmoothedResponsesTest, "Linear Model - Basicity (Test Results)")
visualise.plotTimeSeriesResults(testResultsForest, origSmoothedResponsesTest, "Forest Model - Basicity (Test Results)")
...
plt.title("Kalman - Basicity (Test Results)", fontsize=15)
