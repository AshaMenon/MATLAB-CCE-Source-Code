...
{
    public class APLethePeriodAverage : LetheCalculation
    {
       ...
       // private AFAttributeList DataPointInputAttributes = new AFAttributeList();
        ...
        /// 
        /// </summary>
        public APLethePeriodAverage() : base() { }

        /// <summary>
        /// construct calc
        /// </summary>
        /// <param name="CalculationElement"></param>
        public APLethePeriodAverage(AFElement CalculationElement) : base(CalculationElement) { }
        ...
        public override AFValues Evaluate(DateTime CalculationTime)
        {
            ...
            try
            {
                ...
                foreach (AFTime t in TimeList)
                {
                    ...
                    {
                        Output.Value = GoodInputsInPeriod.Average();
                    }
                    else
                    {
