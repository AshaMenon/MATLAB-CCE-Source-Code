function [outputs, errorCode] = cceLetheAccountability(parameters, inputs)
    %UNTITLED Summary of this function goes here
    %   Detailed explanation goes here
    
    try
        % Get path of calculation
        filePath = which('cceLetheAccountability.dll');
        if isempty(which("cceLetheAccountability.cceLetheAccountabilityClass"))
            asm = NET.addAssembly(filePath); %#ok<NASGU>
        end     
        
        % Create instance of class and set inputs and parameters
        calcInstance = cceLetheAccountability.cceLetheAccountabilityClass();
        
        % Assign Parameters
        netParams = cceLetheAccountability.Parameters();
        ...
        % Assign Inputs
        netInputs = cceLetheAccountability.Inputs();
