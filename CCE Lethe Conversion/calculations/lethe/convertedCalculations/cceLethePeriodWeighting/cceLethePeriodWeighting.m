function [outputs, errorCode] = cceLethePeriodWeighting(parameters, inputs)
    %UNTITLED Summary of this function goes here
    %   Detailed explanation goes here
    
    try
        % Get path of calculation
        filePath = which('cceLethePeriodWeighting.dll');
        if isempty(which("cceLethePeriodWeighting.cceLethePeriodWeightingClass"))
            asm = NET.addAssembly(filePath); %#ok<NASGU>
        end     
        
        % Create instance of class and set inputs and parameters
        calcInstance = cceLethePeriodWeighting.cceLethePeriodWeightingClass();
        
        % Assign Parameters
        netParams = cceLethePeriodWeighting.Parameters();
        ...
        % Assign Inputs
        netInputs = cceLethePeriodWeighting.Inputs();
