function [outputs, errorCode] = cceLetheSubstitute(parameters, inputs)
    %UNTITLED Summary of this function goes here
    %   Detailed explanation goes here

    try
        % Get path of calculation
        filePath = which('cceLetheSubstitute.dll');
        if isempty(which("cceLetheSubstitute.cceLetheSubstituteClass"))
            asm = NET.addAssembly(filePath); %#ok<NASGU>
        end

        % Create instance of class and set inputs and parameters
        calcInstance = cceLetheSubstitute.cceLetheSubstituteClass();

        % Initialise inputs
        for rollUp = parameters.RollupInputs
            inputs.(rollUp + "Timestamps") = NaT;
            % inputs.(rollUp) = NaN;
            % inputs.(rollUp + "Suffixes") = "";
        end
        ...
        % Ensure all necesarry inputs are included
        ...
        % Assign Parameters
        netParams = cceLetheSubstitute.Parameters();
        ...
        % Assign Inputs
        netInputs = cceLetheSubstitute.Inputs();
