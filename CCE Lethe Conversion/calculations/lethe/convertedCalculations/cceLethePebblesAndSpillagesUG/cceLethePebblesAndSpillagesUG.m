function [outputs, errorCode] = cceLethePebblesAndSpillagesUG(parameters, inputs)
    %UNTITLED Summary of this function goes here
    %   Detailed explanation goes here
    
    try
        % Get path of calculation
        filePath = which('cceLethePebblesAndSpillagesUG.dll');
        if isempty(which("cceLethePebblesAndSpillagesUG.cceLethePebblesAndSpillagesUGClass"))
            asm = NET.addAssembly(filePath); %#ok<NASGU>
        end     
        
        % Create instance of class and set inputs and parameters
        calcInstance = cceLethePebblesAndSpillagesUG.cceLethePebblesAndSpillagesUGClass();
        
        % Assign Parameters
        netParams = cceLethePebblesAndSpillagesUG.Parameters();
        ...
        % Assign Inputs
        netInputs = cceLethePebblesAndSpillagesUG.Inputs();
