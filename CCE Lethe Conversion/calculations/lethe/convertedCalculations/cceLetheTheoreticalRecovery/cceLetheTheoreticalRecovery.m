function [outputs, errorCode] = cceLetheTheoreticalRecovery(parameters, inputs)
    %UNTITLED Summary of this function goes here
    %   Detailed explanation goes here
    
    try
        % Get path of calculation
        filePath = which('cceLetheTheoreticalRecovery.dll');
        if isempty(which("cceLetheTheoreticalRecovery.cceLetheTheoreticalRecoveryClass"))
            asm = NET.addAssembly(filePath); %#ok<NASGU>
        end     
        
        % Create instance of class and set inputs and parameters
        calcInstance = cceLetheTheoreticalRecovery.cceLetheTheoreticalRecoveryClass();
        
        % Assign Parameters
        netParams = cceLetheTheoreticalRecovery.Parameters();
        ...
        % Assign Inputs
        netInputs = cceLetheTheoreticalRecovery.Inputs();
