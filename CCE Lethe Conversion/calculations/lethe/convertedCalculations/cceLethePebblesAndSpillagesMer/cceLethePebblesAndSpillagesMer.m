function [outputs, errorCode] = cceLethePebblesAndSpillagesMer(parameters, inputs)
    %UNTITLED Summary of this function goes here
    %   Detailed explanation goes here
    
    try
        % Get path of calculation
        filePath = which('cceLethePebblesAndSpillagesMer.dll');
        if isempty(which("cceLethePebblesAndSpillagesMer.cceLethePebblesAndSpillagesMerClass"))
            asm = NET.addAssembly(filePath); %#ok<NASGU>
        end     
        
        % Create instance of class and set inputs and parameters
        calcInstance = cceLethePebblesAndSpillagesMer.cceLethePebblesAndSpillagesMerClass();
        
        % Assign Parameters
        netParams = cceLethePebblesAndSpillagesMer.Parameters();
        ...
        % Assign Inputs
        netInputs = cceLethePebblesAndSpillagesMer.Inputs();
